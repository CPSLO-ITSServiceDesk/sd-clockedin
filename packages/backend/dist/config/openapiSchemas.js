...
exports.responses = exports.schemas = void 0;
const ref = (name) => ({
...
function fail(description, schema) {
    return {
        description,
        content: { 'application/json': { schema } },
    };
}
const timestamp = (example) => ({
    type: 'string',
    format: 'date-time',
    example,
});
const clockTime = (example) => ({
    type: 'string',
...
exports.schemas = {
    ...
    ShiftStatus: {
        type: 'string',
        description: 'Live status of a shift relative to now. Arrivals within 10 minutes ' +
    ...
    TermOffDays: {
        ...
        properties: {
            ...
            special_schedules: {
                type: 'array',
                description: 'Dates that follow another weekday\u2019s schedule instead of their own.',
                items: {
                    type: 'object',
                    properties: {
    ...
    TermInput: {
        type: 'object',
        description: 'All fields are optional; omitted fields keep their database defaults.',
        properties: {
    ...
    Schedule: {
        type: 'object',
        description: 'Links a student to a term. The optional dates narrow the schedule to ' +
    ...
    TimeEntry: {
        type: 'object',
        description: 'One clock-in/clock-out pair. `schedule_block_id` is null when the ' +
    ...
    ClockInResult: {
        ...
        properties: {
            ...
            matchedBlock: {
                type: 'object',
                nullable: true,
                description: 'The schedule block the clock-in was attributed to, or null if ' +
    ...
    TodayShiftsResult: {
        ...
        properties: {
            ...
            remoteOnlyStudentIds: {
                type: 'array',
                description: 'Students scheduled today for remote work only. Returned even ' +
    ...
    NormalizationApplyRequest: {
        ...
        properties: {
            matches: {
                type: 'array',
                description: 'Typically the accepted subset of the proposals from the preview.',
                items: {
                    type: 'object',
    ...
    NormalizationApplyResult: {
        ...
        properties: {
            ...
            skipped: {
                type: 'array',
                description: 'Matches rejected during the write, for example when another ' +
    ...
    ImportStudentPreview: {
        ...
        properties: {
            ...
            action: {
                type: 'string',
                description: 'Whether the row matched an existing student by work email or ' +
...
exports.responses = {
    ValidationError: fail('Request failed express-validator checks', ref('ValidationErrorResponse')),
    NotFound: fail('Resource does not exist', ref('ErrorResponse')),
    ServerError: fail('Unexpected server or database error', ref('ErrorResponse')),
    ...
    StudentAssistant: ok('The requested student assistant', ref('StudentAssistant')),
    StudentAssistantCreated: ok('The created student assistant', ref('StudentAssistant')),
    ...
    StudentAnalytics: ok('Punctuality metrics for the student within the term', ref('StudentAnalytics')),
    NormalizationPreview: ok('Proposed and rejected matches, with nothing written yet', ref('NormalizationPreview')),
    NormalizationApplyResult: ok('Counts of applied and skipped matches', ref('NormalizationApplyResult')),
    ScheduleImportResult: ok('Import preview or applied result', ref('ScheduleImportResult')),
