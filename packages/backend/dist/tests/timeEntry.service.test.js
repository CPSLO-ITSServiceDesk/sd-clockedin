...
(0, vitest_1.describe)('timeEntryService - basic existence', () => {
    (0, vitest_1.it)('should have all expected methods', () => {
        ...
        (0, vitest_1.expect)(typeof timeEntryService_1.timeEntryService.getAllOpen).toBe('function');
        ...
        (0, vitest_1.expect)(typeof timeEntryService_1.timeEntryService.autoClockOutOpen).toBe('function');
    });
});
